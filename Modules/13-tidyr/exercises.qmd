...
The gapminder dataset is an intermediate form between purely long and purely wide.
...
```{r}
# insert code here
(mean_continent_metrics <- gap_long %>%
...
# insert code here
gap_long %>%
  unite(ID_var, obstype, year, country, sep = "_") %>%
