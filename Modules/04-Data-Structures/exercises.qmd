...
cats\[, 1\] extracts all row elements of the first column and returns the elements without name attributes, which produces a character vector instead of a list.
...
\
My guess was correct. The function recycled numeric 0 as element for each index of the matrix.
...
matrix_chal7a <- matrix(1:50, ncol = 5, nrow = 10)
...
## your command goes here
matrix_chal7b <- matrix(1:50, ncol = 5, nrow = 10,
                        byrow = TRUE)
```
