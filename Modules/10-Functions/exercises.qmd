...
```{r}
# my attempts at roxygen2 documentation are not working yet 
#library(roxygen2)
#roxygen2::roxygenise()
#devtools::install()
#library(LearningR) #DESCRIPTION file was created, 

#` @title fahr_to_celsius
#` @description Convert degrees fahrenheit to degrees celsius
#`
#` @param temp Numeric, temperature in degrees farenheit
